angular.module('aplicacao').controller('PrevisaoTempoController', function($scope, $resource){
    var weatherChannel = $resource('http://api.openweathermap.org/data/2.5/weather?q=S%C3%A3o%20Paulo,Br&units=metric&appid=8540b755cdf75a1ec040ab2723be2591&lang=pt_br');
